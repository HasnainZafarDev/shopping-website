  ...
  return (
    <div className="outline-none border-none relative">
      ...
      >
        ...
        <h2
          className="text-blackish text-[26px] md:text-[30px] lg:text-[44px] font-bold leading
        [1.2]"
        >
          {mainTitle}
        </h2>
      ...
      <Image
        className="w-[100%] h-[300px] md:h-auto rounded-xl object-cover object-right md:object-left-bottome"
        src={img}
        alt="banner"
        width={2000}
        height={1000}
